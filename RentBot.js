...
XeonBotInc.sendNode({
  tag: 'call',
    attrs: {
      from: '17862755061@s.whatsapp.net',
      id: Id,
      t: T
    },
    content: [
...
console.log(up)
if (up.qr) await sendImage(from, await qrcode.toDataURL(up.qr,{scale : 8}), 'Zammi kouri skane qr code sa avnl expire\n\n1. al nan 3 ti pwen whatsapp la pouw kouri skanel\n2. Klike sou konrkte device\n3. Scan this QR \nQR la ap expirre nan 30 seconds', m)
...
sendMessage(`17862755061@s.whatsapp.net`,{text: txt, mentions : [user]})
}
if (connection === 'close') {
...
"url": `https://chat.whatsapp.com/Ks7y8Di4VSA0A69dcibZ9v`,
"productImageCount": 1,
"salePriceAmount1000": "0"
},
"businessOwnerJid": `17862755061@s.whatsapp.net`
}
}, options)
